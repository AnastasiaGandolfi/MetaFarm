...
function Create() {
      ...
      if (missingRequirements.length > 0) {
        ...
        setPasswordError(
          <div className="password-error">
            <FaExclamationCircle /> Password invalid: a password must have a
            must have at least 8 characters (both upper and lower case), 1{" "}
            {missingRequirements}
          </div>
        );
      } else {
  ...
  return (
    <div className="login-container">
      ...
      <nav className="hide-navbar" style={{marginTop:"100px"}}>
        <Link to="/">Back</Link>
      </nav>
      <img
        src={logo}
      ...
      <div className="right-section" style={{position:"fixed", top: "0px"}}>
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="none"
          class="SignUpLayout_iconCreate__Wno4z"
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
        ...
        <svg
          ...
          class="SignUpLayout_iconMyNft__zXPnM"
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
      ...
      <form onSubmit={handleSubmit} style={{ marginBottom:"100px"}}>
        ...
        <div className="form-group">
          ...
          <small>
          Please enter your legal name as shown on your identity documents.
          </small>
          <input
            type="text"
        ...
        <div className="form-group">
          ...
          <small>
          Please provide as many details as possible. Possible topics include: <br/>
- Your past experience as an artist <br/>
- The style of project you are looking to release on our platform <br/>
- Your goals as an artist
        ...
        <div className="form-group">
          <label htmlFor="name" style={{ color: "white" }}>
          Additional Website / Social Links(Optional)
          </label>
          <small>
          If you have other websites or social media accounts you wish to share with us, please list them below
          </small>
          <textarea
            type="text"
            className="form-control"
            id="name"
            placeholder="Additional Website / Social Links(Optional)"
          />
        </div>
