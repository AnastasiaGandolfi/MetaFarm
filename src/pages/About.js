                    ...
                    render={(comp) => (
                        <ReactFullpage.Wrapper>
                            {fullpages.map(({ text, style, img, description, id }) => (
                                <div key={text} className='custom-section fp-auto-height-responsive' style={style}>
                                    <div className="slide" style={{ backgroundImage: `url(${img})`, backgroundSize: "cover", opacity: 0.6 }}>
