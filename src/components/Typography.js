...
export default function Typography() {
    return (
        <div className='typography-container'>
            <h1>TYPOGRAPHY</h1>
            <span className='text-head'>Buy, sell, and showcase NFTs</span>
            <span className='text-subtle'>from leading creators and brands</span>
            <span className='text-button'>View Drops</span>
            <span className='text-uppercase-button'>Upcoming</span>
            <span className='text-collection-name'>YUROSAKO - OG Collection</span>
